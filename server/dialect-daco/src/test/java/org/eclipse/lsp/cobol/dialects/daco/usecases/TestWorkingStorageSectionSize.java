...
class TestWorkingStorageSectionSize {
  ...
  private static final String LINKAGE =
      "006800 LINKAGE SECTION.                                                   D00443\n"
          + "006900 01  COPY IDMS {~SUBSCHEMA-CTRL!IDMS}.                                     "
          + " D00014\n"
          + "008400 PROCEDURE DIVISION.\n";

  private static final String DACO_COPY =
      "     1 01  {$*LDDATE1M-XDT}.\n"
          + "     2     03 {$*F00-XDT.                                                     1\n"
  ...
  private static final String NAMES_COPY =
  ...
  private static final String CTRL_COPY =
