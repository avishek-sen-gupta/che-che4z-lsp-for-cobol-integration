/*
 * Copyright (c) 2025 DAF Trucks NV.
 *
...
/** A test case for COPY FROM statement with TableData variables */
public class TestDaCoCopyFrom6 {
  ...
  private static final String PROTOCB =
      "       01  {$*ROOT}.\n"
          ...
          + "               07 {$*PR1-XDY`&PR1-XXX} PIC 9(9) OCCURS 9.\n";
