    ...
    */
    ...
    kmkid.addChild(
        GeneratorHelper.createElementaryNode(
            3, "OPDATOdXII", "X(3)", SPACE_VALUE, UsageFormat.UNDEFINED));
    kmkid.addChild(
        GeneratorHelper.createElementaryNode(3, "LAYADR-BII", null, null, UsageFormat.POINTER));
    kmkid.addChild(
        GeneratorHelper.createElementaryNode(
            3, "OPDKOD-XII", "X(4)", SPACE_VALUE, UsageFormat.UNDEFINED));
    kmkid.addChild(
        GeneratorHelper.createElementaryNode(
            3, "PMONAM-XII", "X(8)", SPACE_VALUE, UsageFormat.UNDEFINED));
    kmkid.addChild(
        GeneratorHelper.createElementaryNode(
            3, "ENTNAM-XII", "X(16)", SPACE_VALUE, UsageFormat.UNDEFINED));
    kmkid.addChild(
        GeneratorHelper.createElementaryNode(
            3, "PMT-XII", "X(6)", SPACE_VALUE, UsageFormat.UNDEFINED));
    kmkid.addChild(
        GeneratorHelper.createElementaryNode(3, "PMTBIN-BII", "S9(9)", "ZERO", UsageFormat.COMP));

    ElementaryItemNode rtt =
        GeneratorHelper.createElementaryNode(3, "RTTKOD-XII", null, "ZERO", UsageFormat.UNDEFINED);
    rtt.addChild(
        GeneratorHelper.createElementaryNode(5, "RTTSTS-XII", "X", null, UsageFormat.UNDEFINED));
    rtt.addChild(
        GeneratorHelper.createElementaryNode(5, "RTTMESdNII", "9(3)", null, UsageFormat.UNDEFINED));
