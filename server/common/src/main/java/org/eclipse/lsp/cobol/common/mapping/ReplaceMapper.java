...
class ReplaceMapper implements Mapper {
  ...
  public boolean canApply(MappedCharacter startCharacter, MappedCharacter endCharacter) {
    ...
    return startCharacter.getOriginalPosition() == null
        || endCharacter.getOriginalPosition() == null;
  }
  ...
  public Location apply(MappedCharacter startCharacter, MappedCharacter endCharacter) {
    ...
    if (endCharacter.getOriginalPosition() != null) {
      Range calculatedRange =
          new Range(
              startCharacter.getInstantLocation().getRange().getStart(),
              endCharacter.getOriginalPosition());
      return new Location(startCharacter.getUri(), calculatedRange);
    } else if (startCharacter.getOriginalPosition() != null) {
      Range calculatedRange =
          new Range(
              startCharacter.getOriginalPosition(),
              endCharacter.getInstantLocation().getRange().getEnd());
      return new Location(startCharacter.getUri(), calculatedRange);
    }
    return Optional.ofNullable(startCharacter.getInstantLocation())
        .orElse(endCharacter.getInstantLocation());
  }
}
