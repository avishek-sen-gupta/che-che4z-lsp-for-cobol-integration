...
public class SRImplicitVariablesGenerator {
  ...
  public List<VariableNode> generate() {
    ...
    */
    ...
    variable.addChild(
        new ElementaryItemNode(
            locality, 2, "FILLER", false, "X", null, UsageFormat.UNDEFINED, false, false, false));
    ...
    result.add(
        new ElementaryItemNode(
            locality, 1, "JNIENVPTR", false, null, null, UsageFormat.POINTER, false, false, false));
    result.add(
        new ElementaryItemNode(
            locality,
            1,
    ...
    result.add(
        new ElementaryItemNode(
            locality, 1, "TALLY", true, "9(5)", "ZERO", UsageFormat.BINARY, false, false, false));
    result.add(
        new ElementaryItemNode(
            locality,
            1,
    ...
    result.add(
        new ElementaryItemNode(
            locality, 1, "DAY", false, "9(7)", null, UsageFormat.UNDEFINED, false, false, false));
    result.add(
        new ElementaryItemNode(
            locality, 1, "DATE", false, "9(8)", null, UsageFormat.UNDEFINED, false, false, false));
    result.add(
        new ElementaryItemNode(
            locality,
            1,
    ...
    result.add(
        new ElementaryItemNode(
            locality, 1, "TIME", false, "9(8)", null, UsageFormat.UNDEFINED, false, false, false));
    return result;
  }
}
