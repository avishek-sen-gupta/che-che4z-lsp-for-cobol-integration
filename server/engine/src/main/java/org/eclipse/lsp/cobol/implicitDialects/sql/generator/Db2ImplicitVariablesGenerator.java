...
public class Db2ImplicitVariablesGenerator {
  ...
  public List<VariableNode> generateDb2Nodes(
      Map<CompilerDirectiveName, List<String>> compilerDirectiveMap) {
    /*
         01 SQLCA.
                 05 SQLCAID      PIC X(8).
  ...
  private static void addElement(
      VariableNode parent, int level, String name, String pic, UsageFormat usageFormat) {
    parent.addChild(
        new ElementaryItemNode(
            LOCALITY, level, name, false, pic, null, usageFormat, false, false, false));
  }
  ...
  public static List<VariableNode> generateDatacomNodes() {
    ...
    */
    ...
    variable.addChild(
        new ElementaryItemNode(
            LOCALITY, 5, "SQLCAID", false, "X(8)", null, null, true, false, false));
    variable.addChild(
        new ElementaryItemNode(
            LOCALITY, 5, "SQLCA-LEN", false, "S9(9)", null, UsageFormat.COMP, false, false, false));
    variable.addChild(
        new ElementaryItemNode(
            LOCALITY, 5, "SQLCABC", false, "S9(9)", null, UsageFormat.COMP, true, false, false));
    ...
    variable.addChild(
        new ElementaryItemNode(
            LOCALITY, 5, "SQLERRP", false, "X(8)", null, null, true, false, false));
