...
public class Db2ErrorStrategy extends DefaultErrorStrategy implements MessageServiceProvider {
  ...
  protected void reportMissingToken(Parser recognizer) {
    ...
    beginErrorCondition(recognizer);
    String msg =
        recognizer.getExpectedTokens().contains(Db2SqlLexer.END_EXEC)
  ...
  public Token recoverInline(Parser recognizer) throws RecognitionException {
    ...
    if (context instanceof Db2SqlParser.ExecRuleContext) {
      Db2SqlParser.SqlCodeContext sqlCodeContext =
          ((Db2SqlParser.ExecRuleContext) context).sqlCode();
      ...
      recognizer.notifyErrorListeners(
          missingSymbol, messageService.getMessage(REPORT_MISSING_END_EXEC), null);
