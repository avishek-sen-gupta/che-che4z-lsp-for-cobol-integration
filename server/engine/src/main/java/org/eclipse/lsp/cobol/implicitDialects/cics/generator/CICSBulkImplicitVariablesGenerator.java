...
public class CICSBulkImplicitVariablesGenerator {
  ...
  public VariableNode generate() {
    ...
    */
    ...
    variable.addChild(
        new ElementaryItemNode(
            locality, 2, "EIBDATE", false, "S9(7)", null, UsageFormat.COMP_3, false, false, false));
    variable.addChild(
        new ElementaryItemNode(
            locality,
            2,
    ...
    variable.addChild(
        new ElementaryItemNode(
            locality, 2, "DFHEIGDI", false, "S9(4)", null, UsageFormat.COMP, false, false, false));
    variable.addChild(
        new ElementaryItemNode(
            locality, 2, "EIBCPOSN", false, "S9(4)", null, UsageFormat.COMP, false, false, false));
    variable.addChild(
        new ElementaryItemNode(
            locality, 2, "EIBCALEN", false, "S9(4)", null, UsageFormat.COMP, false, false, false));
    variable.addChild(
        new ElementaryItemNode(
            locality,
            2,
    ...
    variable.addChild(
        new ElementaryItemNode(
            locality, 2, "EIBFN", false, "X(2)", null, UsageFormat.UNDEFINED, false, false, false));
    variable.addChild(
        new ElementaryItemNode(
            locality,
            2,
    ...
    variable.addChild(
        new ElementaryItemNode(
            locality, 2, "EIBDS", false, "X(8)", null, UsageFormat.UNDEFINED, false, false, false));
    variable.addChild(
        new ElementaryItemNode(
            locality,
            2,
    ...
    variable.addChild(
        new ElementaryItemNode(
            locality, 2, "EIBRESP", false, "S9(8)", null, UsageFormat.COMP, false, false, false));
    variable.addChild(
        new ElementaryItemNode(
            locality, 2, "EIBRESP2", false, "S9(8)", null, UsageFormat.COMP, false, false, false));
    variable.addChild(
        new ElementaryItemNode(
            locality,
            2,
