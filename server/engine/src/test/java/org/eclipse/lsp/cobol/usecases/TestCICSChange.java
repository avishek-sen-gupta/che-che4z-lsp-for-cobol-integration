 ...
 * href="https://www.ibm.com/docs/en/cics-ts/6.x?topic=summary-change-phrase">CHANGE PHRASE
 * Command</a> <a
 * href="https://www.ibm.com/docs/en/cics-ts/6.x?topic=summary-change-password">CHANGE PASSWORD
 * Command</a> <a href="https://www.ibm.com/docs/en/cics-ts/6.x?topic=summary-change-task">CHANGE
 * TASK Command</a>
 *
...
public class TestCICSChange {
  ...
  private static final String CHANGE_PHRASE_VALID_ALL =
      "CHANGE PHRASE({$varFour}) CHANGETIME({$varFour}) DAYSLEFT({$varFour})ESMREASON({$varFour})"
          + " ESMRESP({$varFour})EXPIRYTIME({$varFour}) INVALIDCOUNT({$varFour})"
          + " LASTUSETIME({$varFour})NEWPHRASE({$varFour}) NEWPHRASELEN({$varFour})"
          + " PHRASELEN({$varFour}) USERID({$varFour})";
  private static final String CHANGE_PHRASE_INVALID =
      "CHANGE  {PHRASE(100) | errorMissingPhrase | errorMissingPhrase2 |errorMissingPhrase3 |"
          + " errorMissingPhrase4}";
  ...
  private static final String CHANGE_TASK_VALID = "CHANGE TASK";
  private static final String CHANGE_TASK_PRIORTY_VALID = "CHANGE TASK PRIORITY({$varFour})";
