...
public class TestCicsWSAEPR {
  private static final String WSAEPR_CREATE_ALL_OPTIONS_VALID =
      "WSAEPR CREATE EPRINTO(1) EPRLENGTH(1) ADDRESS(2) FROMCCSID(1)"
          + "  REFPARMS(1) REFPARMSLEN(1) METADATA(1) METADATALEN(1)";

  private static final String WSAEPR_CREATE_SOME_OPTIONS_VALID_ONE =
      "WSAEPR EPRLENGTH(1) CREATE ADDRESS(2) EPRSET(1) FROMCODEPAGE(1)";
  private static final String WSAEPR_CREATE_SOME_OPTIONS_VALID_TWO =
      "WSAEPR CREATE FROMCODEPAGE(3) EPRLENGTH(1) REFPARMS(2) EPRSET(1)";
  private static final String WSAEPR_CREATE_SOME_OPTIONS_VALID_THREE =
      "WSAEPR EPRINTO(1) EPRLENGTH(1) METADATA(2) CREATE METADATALEN(2)";

  private static final String WSAEPR_CREATE_BARE_VALID =
      "WSAEPR CREATE EPRINTO(2) EPRLENGTH(1) METADATA(1)";
