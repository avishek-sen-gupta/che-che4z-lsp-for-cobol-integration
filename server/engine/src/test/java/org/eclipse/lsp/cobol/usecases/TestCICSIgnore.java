 ...
 * href="https://www.ibm.com/docs/en/cics-ts/6.x?topic=summary-ignore-condition">IGNORE CONDITION
 * Command</a>
 *
 * <p>This class tests the IGNORE CONDITION command.
 */
public class TestCICSIgnore {
  private static final String IGNORE_CONDITION_VALID_ONE = "IGNORE CONDITION ERROR";

  private static final String IGNORE_CONDITION_VALID_MULTIPLE =
      "IGNORE CONDITION ERROR MAPFAIL PARTNFAIL";

  private static final String IGNORE_CONDITION_INVALID_ONE = "IGNORE {ERROR|errorOne}";
