...
public class TestCICSForceStatement {
  private static final String FORCE_TIMER_VALID = "FORCE TIMER({$varFour})";
  private static final String FORCE_TIMER_ALL_VALID = "FORCE TIMER({$varFour}) ACQACTIVITY";
  private static final String FORCE_TIMER_INVALID = "FORCE {ACQACTIVITY|errorMissingTimer}";
