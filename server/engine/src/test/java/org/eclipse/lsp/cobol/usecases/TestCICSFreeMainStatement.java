...
/**
 * Test CICS Freemain & Freemain64 commands. Documentation link: <a
 * href="https://www.ibm.com/docs/en/cics-ts/6.x?topic=summary-freemain">Freemain Command</a> <a
 * href="https://www.ibm.com/docs/en/cics-ts/6.x?topic=summary-freemain64">Freemain64 Command</a>
 *
...
public class TestCICSFreeMainStatement {
  private static final String FREEMAIN_DATA_VALID = "FREEMAIN DATA({$varFour})";
  private static final String FREEMAIN64_DATA_INVALID = "{FREEMAIN64|errorOne} DATA({$varFour})";
  private static final String FREEMAIN_DATAPOINTER_VALID = "FREEMAIN DATAPOINTER({$varFour})";
