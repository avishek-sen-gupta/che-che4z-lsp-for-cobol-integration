...
class TestControlStatements {
  ...
  private static Stream<Arguments> listDirectives() {
    return Stream.of(
        ...
        Arguments.of("QUOTE"),
        Arguments.of("Q"),
        Arguments.of("ARITH(COMPAT)"),
        Arguments.of("ARITH(EXTEND)"),
        Arguments.of("AR(C)"),
        Arguments.of("AR(E)"),
        Arguments.of("CICS"),
        Arguments.of("NOCICS"),
        ...
        Arguments.of("NOCURRENCY"),
        Arguments.of("CURR($)"),
        Arguments.of("NOCURR"),
        Arguments.of("DBCS"),
        Arguments.of("NODBCS"),
        Arguments.of("NSYMBOL(NATIONAL)"),
        Arguments.of("NSYMBOL(DBCS)"),
        Arguments.of("NS(NAT)"),
        Arguments.of("NS(DBCS)"),
        Arguments.of("NUMBER"),
        Arguments.of("NONUMBER"),
        Arguments.of("NUM"),
        Arguments.of("NONUM"),
        Arguments.of("QUALIFY(COMPAT)"),
        Arguments.of("QUALIFY(EXTEND)"),
        Arguments.of("QUA(C)"),
        Arguments.of("QUA(E)"),
        Arguments.of("SEQUENCE"),
        Arguments.of("NOSEQUENCE"),
        Arguments.of("SEQ"),
        Arguments.of("NOSEQ"),
        Arguments.of("NOSQL"),
        Arguments.of("SQL"),
        Arguments.of("SQL(\"string1\")"),
        Arguments.of("SQLCCSID"),
        Arguments.of("NOSQLCCSID"),
        Arguments.of("SQLC"),
        Arguments.of("NOSQLC"),
        Arguments.of("NOSQLIMS"),
        Arguments.of("SQLIMS"),
        Arguments.of("SQLIMS(\"string1\")"),
        Arguments.of("SUPPRESS"),
        Arguments.of("NOSUPPRESS"),
        Arguments.of("SUPP"),
        Arguments.of("NOSUPP"),
        Arguments.of("NOWORD"),
        Arguments.of("WORD(CICS)"),
        Arguments.of("NOWD"),
        Arguments.of("WD(CICS)"),
        Arguments.of("XMLPARSE(XMLSS)"),
        Arguments.of("XMLPARSE(COMPAT)"),
        Arguments.of("XP(X)"),
        Arguments.of("XP(C)"),
        Arguments.of("INTDATE(ANSI)"),
        Arguments.of("INTDATE(LILIAN)"),
        Arguments.of("LANGUAGE(ENGLISH)"),
        Arguments.of("LANGUAGE(JAPANESE)"),
        Arguments.of("LANGUAGE(UENGLISH)"),
        Arguments.of("LANG(EN)"),
        Arguments.of("LANG(UE)"),
        Arguments.of("LANG(JA)"),
        Arguments.of("LANG(JP)"),
        Arguments.of("LINECOUNT(60)"),
        Arguments.of("LC(60)"),
        Arguments.of("LIST"),
        Arguments.of("NOLIST"),
        Arguments.of("NOMAP"),
        Arguments.of("MAP"),
        Arguments.of("MAP(HEX)"),
        Arguments.of("MAP(DEC)"),
        Arguments.of("NOOFFSET"),
        Arguments.of("OFFSET"),
        Arguments.of("NOOFF"),
        Arguments.of("OFF"),
        Arguments.of("SOURCE"),
        Arguments.of("NOSOURCE"),
        Arguments.of("S"),
        Arguments.of("NOS"),
        Arguments.of("SPACE(1)"),
        Arguments.of("SPACE(2)"),
        Arguments.of("SPACE(3)"),
        Arguments.of("TERMINAL"),
        Arguments.of("NOTERMINAL"),
        Arguments.of("TERM"),
        Arguments.of("NOTERM"),
        Arguments.of("VBREF"),
        Arguments.of("NOVBREF"),
        Arguments.of("NOXREF"),
        Arguments.of("XREF"),
        Arguments.of("XREF(FULL)"),
        Arguments.of("XREF(SHORT)"),
        Arguments.of("NOX"),
        Arguments.of("X"),
        Arguments.of("X(FULL)"),
        Arguments.of("X(SHORT)"),
        Arguments.of("COMPILE"),
        Arguments.of("NOCOMPILE"),
        ...
        Arguments.of("NOC(E)"),
        Arguments.of("NOC(W)"),
        Arguments.of("NOCOPYRIGHT"),
        Arguments.of("COPYRIGHT('copyright string')"),
        Arguments.of("NOCPYR"),
        Arguments.of("CPYR('copyright string')"),
        Arguments.of("DECK"),
        Arguments.of("NODECK"),
        Arguments.of("D"),
        Arguments.of("NOD"),
        ...
        Arguments.of("NONAME"),
        Arguments.of("OBJECT"),
        Arguments.of("NOOBJECT"),
        Arguments.of("OBJ"),
        Arguments.of("NOOBJ"),
        Arguments.of("PGMNAME(COMPAT)"),
        Arguments.of("PGMNAME(LONGMIXED)"),
        Arguments.of("PGMNAME(LONGUPPER)"),
        Arguments.of("PGMN(CO)"),
        Arguments.of("PGMN(LM)"),
        Arguments.of("PGMN(LU)"),
        Arguments.of("NOSERVICE"),
        Arguments.of("SERVICE('service string')"),
        Arguments.of("NOSERV"),
        Arguments.of("SERV('copyright string')"),
        Arguments.of("ADV"),
        Arguments.of("NOADV"),
        Arguments.of("AFP(VOLATILE)"),
        Arguments.of("AFP(NOVOLATILE)"),
        Arguments.of("ARCH(7)"),
        Arguments.of("ARCH(8)"),
        Arguments.of("ARCH(9)"),
        ...
        Arguments.of("NOAWO"),
        Arguments.of("BLOCK0"),
        Arguments.of("NOBLOCK0"),
        Arguments.of("DISPSIGN(COMPAT)"),
        Arguments.of("DISPSIGN(SEP)"),
        Arguments.of("DS(C)"),
        Arguments.of("DS(S)"),
        Arguments.of("DLL"),
        Arguments.of("NODLL"),
        Arguments.of("EXPORTALL"),
        Arguments.of("NOEXPORTALL"),
        Arguments.of("EXP"),
        Arguments.of("NOEXP"),
        Arguments.of("FASTSRT"),
        Arguments.of("NOFASTSRT"),
        Arguments.of("FSRT"),
        Arguments.of("NOFSRT"),
        Arguments.of("HGPR(PRESERVE)"),
        Arguments.of("HGPR(NOPRESERVE)"),
        Arguments.of("INLINE"),
        Arguments.of("NOINLINE"),
        Arguments.of("INL"),
        Arguments.of("NOINL"),
        Arguments.of("MAXPCF(60000)"),
        Arguments.of("NUMCHECK"),
        Arguments.of("NONUMCHECK"),
        Arguments.of("NUMCHECK(ABD)"),
        Arguments.of("NUMCHECK(MSG)"),
        Arguments.of("NUMCHECK(NOBIN)"),
        Arguments.of("NUMCHECK(BIN)"),
        Arguments.of("NUMCHECK(NOPAC)"),
        Arguments.of("NUMCHECK(PAC)"),
        Arguments.of("NUMCHECK(NOZON)"),
        Arguments.of("NUMCHECK(ZON)"),
        Arguments.of("NUMCHECK(ZON(ALPHNUM))"),
        Arguments.of("NUMCHECK(ZON(NOALPHNUM))"),
        Arguments.of("NUMCHECK(ZON(NOALPHNUM),NOBIN,PAC)"),
        Arguments.of("NC"),
        Arguments.of("NONC"),
        Arguments.of("NC(ABD)"),
        Arguments.of("NC(MSG)"),
        Arguments.of("NC(NOBIN)"),
        Arguments.of("NC(BIN)"),
        Arguments.of("NC(NOPAC)"),
        Arguments.of("NC(PAC)"),
        Arguments.of("NC(NOZON)"),
        Arguments.of("NC(ZON)"),
        Arguments.of("NC(ZON(ALPHNUM))"),
        Arguments.of("NC(ZON(NOALPHNUM))"),
        Arguments.of("NC(ZON(NOALPHNUM),NOBIN,PAC)"),
        Arguments.of("NUMPROC(NOPFD)"),
        Arguments.of("NUMPROC(PFD)"),
        ...
        Arguments.of("ZONECHECK(ABD)"),
        Arguments.of("ZONECHECK(MSG)"),
        Arguments.of("NOZC"),
        Arguments.of("ZC(ABD)"),
        Arguments.of("ZC(MSG)"),
        ...
        Arguments.of("ZWB"),
        Arguments.of("NOZWB"),
        Arguments.of("BUFSIZE(4096)"),
        Arguments.of("BUFSIZE(4K)"),
        Arguments.of("BUF(4096)"),
        Arguments.of("BUF(4K)"),
        Arguments.of("DATA(31)"),
        Arguments.of("DATA(24)"),
        Arguments.of("DYNAM"),
        Arguments.of("NODYNAM"),
        Arguments.of("DYN"),
        Arguments.of("NODYN"),
        Arguments.of("RENT"),
        Arguments.of("NORENT"),
        ...
        Arguments.of("STGOPT"),
        Arguments.of("NOSTGOPT"),
        Arguments.of("SO"),
        Arguments.of("NOSO"),
        Arguments.of("DIAGTRUNC"),
        Arguments.of("NODIAGTRUNC"),
        Arguments.of("DTR"),
        Arguments.of("NODTR"),
        Arguments.of("DUMP"),
        Arguments.of("NODUMP"),
