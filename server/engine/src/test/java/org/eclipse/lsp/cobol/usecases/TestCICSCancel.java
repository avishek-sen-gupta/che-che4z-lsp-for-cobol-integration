 ...
 * href="https://www.ibm.com/docs/en/cics-ts/6.x?topic=summary-cancel">CANCEL Command</a> <a
 * https://www.ibm.com/docs/en/cics-ts/6.x?topic=summary-cancel-bts">CANCEL(BTS) Command</a>
 *
 * <p>This class tests all variations of the CANCEL command found in the link above.
 */
public class TestCICSCancel {

  private static final String CANCEL_ACTIVITY_VALID = "CANCEL ACTIVITY({$varOne})";

  private static final String CANCEL_ACQACTIVITY_VALID = "CANCEL ACQACTIVITY";

  private static final String CANCEL_ACQPROCESS_VALID = "CANCEL ACQPROCESS";
  private static final String CANCEL_REQID_VALID = "CANCEL REQID({$varFour})";
  ...
  private static final String CANCEL_TRANSID_INVALID = "CANCEL {TRANSID(100) | errorTransid} ";
