...
public class TestCICSHandle {
  private static final String HANDLE_ABEND_VALID = "HANDLE ABEND PROGRAM({$varOne})";

  private static final String HANDLE_ABEND_INVALID = "HANDLE {CANCEL|errorOne}";

  private static final String HANDLE_AID_VALID_ONE = "HANDLE AID ANYKEY({@SEC1})";

  private static final String HANDLE_AID_VALID_TWO = "HANDLE AID PF1({@SEC1})";

  private static final String HANDLE_AID_INVALID = "HANDLE {_ANYKEY({@SEC1})|errorOne_}";

  private static final String HANDLE_AID_VALID_THREE = "HANDLE AID PF1({@SEC1}) PF3";
  ...
  private static final String HANDLE_CONDITION_VALID = "HANDLE CONDITION EOC({@SEC1})";

  private static final String HANDLE_CONDITION_VALID_ONE = "HANDLE CONDITION ERROR";

  private static final String HANDLE_CONDITION_VALID_TWO = "HANDLE CONDITION";

  private static final String HANDLE_CONDITION_INVALID_ONE = "HANDLE {ERROR|errorOne}";
