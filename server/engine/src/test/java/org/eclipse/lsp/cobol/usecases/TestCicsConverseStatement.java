...
public class TestCicsConverseStatement {
  ...
  private static final String LU23_3270_VALID_2 =
      CONVERSE_FROM_INTO
          + "ERASE DEFAULT CTLCHAR(123) TOLENGTH(123) MAXLENGTH(123) DEFRESP NOTRUNCATE ASIS";
  private static final String LU23_3270_VALID_3 =
      CONVERSE_FROM_INTO + "ERASE ALTERNATE CTLCHAR(123) TOLENGTH(123) MAXLENGTH(123)";
  private static final String LU23_3270_VALID_4 =
      CONVERSE_FROM_INTO + "ERASE TOLENGTH(123) MAXLENGTH(123)";
  private static final String LU23_3270_VALID_5 =
  ...
  void testDefaultInvalid_1() {
    CICSTestUtils.errorTest(
        DEFAULT_INVAL_1, getErrorDiagnostic("Excessive options provided for: NOTRUNCATE"));
  }
  ...
  void testDefaultInvalid_2() {
    CICSTestUtils.errorTest(
        DEFAULT_INVAL_2,
        getErrorDiagnostic(
            "Options \"FROMLENGTH or FROMFLENGTH\" cannot be used more than once in a given"
                + " command."));
  }
