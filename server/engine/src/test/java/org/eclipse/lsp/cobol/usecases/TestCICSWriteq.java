 ...
 * href="https://www.ibm.com/docs/en/cics-ts/6.x?topic=summary-writeq-td">WRITEQ TD Command</a> and
 * <a href="https://www.ibm.com/docs/en/cics-ts/6.x?topic=summary-writeq-ts">WRITEQ TS Command</a>
 *
...
public class TestCICSWriteq {
  ...
  private static final String WRITEQ_TD_INVALID_ONE = "WRITEQ {_TD FROM(123)|errorOne_}";

  private static final String WRITEQ_TD_INVALID_TWO = "WRITEQ {_TD QUEUE(123)|errorOne_}";
