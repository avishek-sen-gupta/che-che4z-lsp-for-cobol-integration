 ...
 * href="https://www.ibm.com/docs/en/cics-ts/6.x?topic=summary-add-subevent">ADD SUBEVENT
 * Command</a>
 *
 * <p>This class tests all variations of the ADD SUBEVENT command found in the link above.
 */
public class TestCICSAddSubevent {
  private static final String ADD_SUBEVENT_EVENT = "ADD SUBEVENT({$varFour}) EVENT({$varFour})";
  private static final String ADD_EVENT_SUBEVENT = "ADD EVENT({$varFour}) SUBEVENT({$varFour})";
  private static final String ADD_INVALID = "ADD ";
  private static final String ADD_EVENT_INVALID = "ADD {EVENT(100) | errorMissingSubevent} ";
  private static final String ADD_SUBEVENT_INVALID = "ADD {SUBEVENT(100) | errorMissingEvent} ";
