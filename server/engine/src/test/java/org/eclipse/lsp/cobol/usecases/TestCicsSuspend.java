 ...
 * href="https://www.ibm.com/docs/en/cics-ts/6.x?topic=summary-suspend">SUSPEND Command</a>
 *
...
public class TestCicsSuspend {
  ...
  private static final String SUSPEND_INVALID_ONE =
      "SUSPEND {ACQACTIVITY|error1} {ACQPROCESS|error1}";
  private static final String SUSPEND_INVALID_TWO =
      "SUSPEND {ACTIVITY|error1}({$varOne}) {ACQPROCESS|error1}";
  private static final String SUSPEND_INVALID_THREE =
      "SUSPEND {ACQACTIVITY|error1} {ACTIVITY|error1}({$varOne})";
  ...
  void testSuspendInvalidOne() {
    Map<String, Diagnostic> expectedDiagnostic =
        ImmutableMap.of(
            ...
            new Diagnostic(
                new Range(),
                "Exactly one option required, options are mutually exclusive: ACQACTIVITY or"
                    + " ACQPROCESS or ACTIVITY",
